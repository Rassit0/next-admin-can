import { AddModal, getStudents, TableStudents } from "@/modules/students";
...
export default async function StudentsPage({ searchParams }: Props) {
  ...
  if (studentsResponse.error) {
    return <ErrorPage message={studentsResponse.message} />;
  }
  return (
    <>
      ...
      <div className="flex flex-col space-y-3">
        ...
        <SectionFilters />
        {/* <!-- Main Member Table --> */}
        <TableStudents students={studentsResponse.data.data} />
        {/* <!-- Pagination --> */}
        <PaginationSection
          totalPages={studentsResponse.data?.meta.totalPages}
          itemsPerPage={studentsResponse.data?.meta.itemsPerPage}
          totalItems={studentsResponse.data?.meta.totalItems}
        />
      </div>
    </>
  );
