...
import { toggleBillingEngineTeamSeason } from "../../actions/toggle-billing";
import { toast } from "sonner";
import { ITeamSeasonBillingConfig } from "../../interfaces/team-season.interface";
...
export const ButtonToggleBillingEngine = ({
  ...
  const handleToggle = async () => {
    setLoading(true);
    const result = await toggleBillingEngineTeamSeason(
      teamSeasonId,
      !isEngineActive,
    );
