              ...
              <Switch isSelected={isMigrated} onChange={setIsMigrated}>
                <Switch.Content>
                  ...
                  <Label className="text-sm flex items-center">
                    ...
                    <InfoTooltip text="Activa esta opción si el atleta ya inicó su temporada en otro sistema, y sólo deseas facturarle desde el mes actual en adelante. Ignorará cuotas de meses previos." />
                  </Label>
                </Switch.Content>
              </Switch>
            </div>
