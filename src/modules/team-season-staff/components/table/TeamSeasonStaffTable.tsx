...
export const TeamSeasonStaffTable = ({ staffList, teamSeason }: Props) => {
  ...
  const handleRemove = async (id: string) => {
    ...
    setLoadingId(id);
    const res = await removeTeamSeasonStaff(id);
    setLoadingId(null);
  ...
  return (
    <Table>
      <Table.ScrollContainer>
        <Table.Content aria-label="Personal del equipo" className="min-w-200">
