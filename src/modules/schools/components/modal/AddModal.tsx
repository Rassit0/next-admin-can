...
import { FormSchool, IDisciplineOptions } from "@/modules/schools";
        ...
        <Modal.Container placement="auto" scroll="outside">
          <Modal.Dialog className="sm:max-w-md bg-background-tertiary">
            ...
            <Modal.Header>
              ...
              <Modal.Heading>Agregar School</Modal.Heading>
              <p className="mt-1.5 text-sm leading-5 text-muted">
                Agrega un nuevo school al sistema.
              </p>
            </Modal.Header>
            <Modal.Body className="p-0 md:p-6">
              <FormSchool
                disciplineId={disciplineId}
                formId="add-school-form"
