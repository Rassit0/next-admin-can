...
export const courseDetails: CourseDetail[] = [
  {
    ...
    weeklySchedule: ["Lunes 17:00-18:00", "Miércoles 17:00-18:00"],
  ...
  },
  {
    ...
    professors: [
      { id: "p3", name: "Carlos López", specialty: "Raqueta Frontón Avanzado" },
    ],
  },
  {
    id: "c3",
...
export const eventDetails: EventDetail[] = [
  {
    ...
    description:
      "Enfrentamiento histórico entre dos grandes potencias del voleibol metropolitano. Un partido que promete intensidad, emoción y espectáculo. Entrada libre para miembros del club. Transmisión en vivo.",
