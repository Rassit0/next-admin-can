...
export const ExtendModal = ({ isOpen, onOpenChange, courseSeason }: Props) => {
  ...
  const handleExtend = async () => {
    ...
    setIsLoading(true);
    const res = await extendCourseSeason(courseSeason.id, {
          ...
          <AlertDialog.Header className="items-center text-center">
            ...
            <AlertDialog.Heading className="flex flex-col">
              ...
              <span className="text-muted">
                Estás por extender el ciclo de {courseSeason.name}
              </span>
            </AlertDialog.Heading>
          </AlertDialog.Header>
          <AlertDialog.Body>
