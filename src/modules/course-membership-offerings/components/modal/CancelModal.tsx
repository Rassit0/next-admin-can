...
export const CancelModal = ({ isOpen, onOpenChange, courseSeason }: Props) => {
  ...
  const handleFinalize = async () => {
    ...
    setIsLoading(true);
    const res = await cancelCourseSeason(courseSeason.id, statusNotes);
    setIsLoading(false);
    if (res.error) {
          ...
          <AlertDialog.Header className="items-center text-center">
            ...
            <AlertDialog.Heading className="flex flex-col">
              ...
              <span className="text-muted">
                Estás por cancelar el ciclo de {courseSeason.name}: Esta acción es
                irreversible
              </span>
            </AlertDialog.Heading>
          </AlertDialog.Header>
