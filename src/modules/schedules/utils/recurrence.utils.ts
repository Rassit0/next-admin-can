...
export const buildSchedulePayload = (
  ...
  // confiamos en que el backend lo materializari¡ en la zona enviada o en UTC
  ...
  // untilDate viene como YYYY-MM-DD. Le ponemos 23:59:59 para asegurar que cubra el iºltimo di­a.
  ...
  return {
    ...
    teamSeasonIds: relations.teamSeasonId
      ? [relations.teamSeasonId]
      : undefined,
    courseSeasonIds: relations.courseSeasonId
      ? [relations.courseSeasonId]
      : undefined,
  };
};
