...
export const EditHeroBannerModal = ({ isOpen, setIsOpen, heroBanner, showButton }: Props) => {
        ...
        <Modal.Dialog className="sm:max-w-4xl bg-background-tertiary">
          ...
          <Modal.Body className="p-6">
            <HeroBannerForm
              ...
              formId={`edit-hero-banner-form-${heroBanner.id}`}
          ...
          <Modal.Footer>
            ...
            <Button
              type="submit"
              form={`edit-hero-banner-form-${heroBanner.id}`}
              isPending={isLoading}
            >
              {isLoading && (
