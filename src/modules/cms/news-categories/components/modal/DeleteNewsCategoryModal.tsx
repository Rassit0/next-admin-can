...
import { deleteNewsCategory } from "../../actions/delete";
...
export const DeleteNewsCategoryModal = ({ id, isOpen, setIsOpen }: Props) => {
        ...
        <Modal.Dialog className="sm:max-w-md bg-background-tertiary">
          ...
          <Modal.Body className="p-6">
            <p className="text-sm text-muted">
              ¿Estás seguro de que deseas eliminar esta categorí­a? Esta
              accón no se puede deshacer.
            </p>
          </Modal.Body>
          <Modal.Footer>
            <Button
