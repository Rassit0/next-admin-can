...
export const HeaderPageLouncher = () => {
  return (
    <section className="mb-8 md:mb-12 relative overflow-hidden rounded-[2rem] bg-linear-to-bl from-accent dark:from-accent to-background-inverse dark:to-background p-6 md:p-12 text-white">
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="text-base md:text-lg text-accent-fixed opacity-90 font-body mb-6 md:mb-8">
          Administre con precisón atlética. Supervise el crecimiento de
        ...
        {/* <div className="flex sm:flex-row flex-col gap-4">
          <div className="bg-surface-container-lowest/10 backdrop-blur-md border border-white/10 p-4 rounded-2xl flex items-center space-x-4 flex-1">
            ...
            <div>
              <p className="text-xl md:text-2xl font-headline font-bold">1,284</p>
              <p className="text-xs text-accent-fixed">Socios Activos</p>
            </div>
          </div>
          <div className="bg-surface-container-lowest/10 backdrop-blur-md border border-white/10 p-4 rounded-2xl flex items-center space-x-4 flex-1">
            <div className="p-3 bg-tertiary-container rounded-xl flex items-center justify-center">
              <HugeiconsIcon icon={ArrowUpRight01Icon} className="text-white" size={24} />
            </div>
            <div>
              <p className="text-xl md:text-2xl font-headline font-bold">+12%</p>
