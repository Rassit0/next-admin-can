...
import { deleteBanner } from "../../actions/delete";
...
export const DeleteBannerModal = ({ isOpen, setIsOpen, id }: Props) => {
        ...
        <Modal.Dialog className="sm:max-w-md bg-background-tertiary">
          ...
          <Modal.Header>
            <div className="flex gap-2 items-center ">
              ...
              <Modal.Heading>Eliminar Banner</Modal.Heading>
            </div>
          </Modal.Header>
          <Modal.Body className="px-6 py-4">
            <p className="text-sm text-default-500">
              ¿Estás seguro de que deseas eliminar este banner? Esta acción no se
              puede deshacer y el banner dejará de ser visible de inmediato.
            </p>
          </Modal.Body>
          <Modal.Footer>
            <Button
