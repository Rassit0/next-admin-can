...
const mockNavigation: NavigationConfig[] = [
  {
    ...
    routes: [
      { id: 'accounting-dashboard', label: 'Dashboard', action: 'accounting', subject: 'ACCOUNT_CHARGES', href: '/admin/accounting/dashboard', showInTabs: true, requiredPermissions: { anyOf: ['READ_ACCOUNT_CHARGES', 'READ_TRANSACTIONS'] } },
      { id: 'accounting-categories', label: 'Categorias', action: 'accounting', subject: 'ACCOUNT_CATEGORIES', href: '/admin/accounting/categories', showInTabs: true, requiredPermissions: { anyOf: ['READ_ACCOUNT_CATEGORIES'] } },
    ],
  },
  {
    id: 'memberships',
    ...
    routes: [
      { id: 'memberships-players', label: 'Players', action: 'memberships', subject: 'PLAYER_MEMBERSHIPS', href: '/admin/memberships/player-memberships', showInTabs: true, requiredPermissions: { anyOf: ['READ_PLAYER_MEMBERSHIPS'] } },
      { id: 'memberships-students', label: 'Students', action: 'memberships', subject: 'STUDENT_MEMBERSHIPS', href: '/admin/memberships/student-memberships', showInTabs: true, requiredPermissions: { anyOf: ['READ_STUDENT_MEMBERSHIPS'] } },
    ],
  },
  {
    id: 'web',
    ...
    routes: [
      { id: 'web-news', label: 'News', action: 'web', subject: 'NEWS', href: '/admin/web/news', showInTabs: true, requiredPermissions: { anyOf: ['READ_NEWS'] } },
      { id: 'web-banners', label: 'Banners', action: 'web', subject: 'BANNERS', href: '/admin/web/hero-banners', showInTabs: true, requiredPermissions: { anyOf: ['MANAGE_WEB'] } },
    ],
  },
  {
    id: 'quick-operations',
    ...
    routes: [
      { id: 'quick-ops-person', label: 'Person', action: 'quick-operations', subject: 'PERSONS', href: '/admin/quick-operations/[personId]', showInTabs: false, requiredPermissions: { anyOf: ['READ_PERSONS'] } },
      { id: 'quick-ops-cash', label: 'Cash', action: 'quick-operations', subject: 'TRANSACTIONS', href: '/admin/quick-operations/cash-flow', showInTabs: true, requiredPermissions: { anyOf: ['READ_TRANSACTIONS'] } },
    ],
  },
];
